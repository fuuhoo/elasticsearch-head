i18n.setKeys({
	...
	"FilterBrowser.SortField": "排序字段: {0}",
	"FilterBrowser.SortOrder": "排序顺序: {0}",
	"FilterBrowser.SortFieldLabel": "排序字段",
	"FilterBrowser.SortOrderLabel": "排序顺序",
	"FilterBrowser.SortTitle": "排序（可多字段，自上而下优先）",
	"FilterBrowser.SortNone": "默认(_score)",
