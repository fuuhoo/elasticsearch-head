i18n.setKeys({
	...
	"FilterBrowser.SortField": "Campo de Ordenação: {0}",
	"FilterBrowser.SortOrder": "Ordem: {0}",
	"FilterBrowser.SortFieldLabel": "Campo de Ordenação",
	"FilterBrowser.SortOrderLabel": "Ordem",
	"FilterBrowser.SortTitle": "Ordenação (vários campos, topo tem prioridade)",
	"FilterBrowser.SortNone": "Padrão (_score)",
	"FilterBrowser.SortAsc": "Crescente",
	"FilterBrowser.SortDesc": "Decrescente",
	...
	"Header.AuthUser": "Usuário",
	"Header.AuthPassword": "Senha",
