...
//	"IndexSelector.NameWithDocs": "{0} ({1} docs)",
	...
	"FilterBrowser.SortField": "ソートフィールド: {0}",
	"FilterBrowser.SortOrder": "ソート順: {0}",
	"FilterBrowser.SortFieldLabel": "ソートフィールド",
	"FilterBrowser.SortOrderLabel": "ソート順",
	"FilterBrowser.SortTitle": "ソート（複数フィールド可、上が優先）",
	"FilterBrowser.SortNone": "デフォルト(_score)",
	"FilterBrowser.SortAsc": "昇順",
	"FilterBrowser.SortDesc": "降順",
