i18n.setKeys({
	...
	"FilterBrowser.SortField": "Sıralama Alanı: {0}",
	"FilterBrowser.SortOrder": "Sıralama: {0}",
	"FilterBrowser.SortFieldLabel": "Sıralama Alanı",
	"FilterBrowser.SortOrderLabel": "Sıralama",
	"FilterBrowser.SortTitle": "Sıralama (birden fazla alan, üstteki öncelikli)",
	"FilterBrowser.SortNone": "Varsayılan (_score)",
	"FilterBrowser.SortAsc": "Artan",
	"FilterBrowser.SortDesc": "Azalan",
