i18n.setKeys({
	...
	"FilterBrowser.SortField": "排序欄位: {0}",
	"FilterBrowser.SortOrder": "排序順序: {0}",
	"FilterBrowser.SortFieldLabel": "排序欄位",
	"FilterBrowser.SortOrderLabel": "排序順序",
	"FilterBrowser.SortTitle": "排序（可多欄位，由上而下優先）",
	"FilterBrowser.SortNone": "預設(_score)",
	"FilterBrowser.SortAsc": "升序",
	"FilterBrowser.SortDesc": "降序",
