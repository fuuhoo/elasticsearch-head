i18n.setKeys({
	...
	"FilterBrowser.SortField": "Trường sắp xếp: {0}",
	"FilterBrowser.SortOrder": "Thứ tự: {0}",
	"FilterBrowser.SortFieldLabel": "Trường sắp xếp",
	"FilterBrowser.SortOrderLabel": "Thứ tự",
	"FilterBrowser.SortTitle": "Sắp xếp (nhiều trường, dòng trên ưu tiên)",
	"FilterBrowser.SortNone": "Mặc định (_score)",
	"FilterBrowser.SortAsc": "Tăng dần",
	"FilterBrowser.SortDesc": "Giảm dần",
